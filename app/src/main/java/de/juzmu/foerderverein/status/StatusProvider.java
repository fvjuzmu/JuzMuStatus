...
public class StatusProvider extends AppWidgetProvider {
    private static final String TAG = "juzmustatus";
    private static final String URI_SCHEME = "juzmustatus";
    private static final String INTENT_PREFIX = "de.juzmu.foerderverein.status";
    ...
    public void onUpdate(Context context, AppWidgetManager manager, int[] appWidgetIds) {
        ...
        for (int appWidgetId : appWidgetIds) {
            ...
            if (firstUpdate) {
                ...
                RemoteViews update = new RemoteViews(context.getPackageName(), R.layout.juzmustatus);
    ...
    class UpdateWidgetTask extends AsyncTask<Void, Void, Character> {
        ...
        protected Character doInBackground(Void... param) {
            Log.d(TAG, "Getting update from http://foerderverein-juzmu.de/juzmustatus/juz_status.txt");

            HttpGet request = new HttpGet("http://foerderverein-juzmu.de/juzmustatus/juz_status.txt");
